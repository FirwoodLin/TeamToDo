...
})({"ftFza":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ddeb7fafcfbd1baa";
"use strict";
...
},{}],"g3FPD":[function(require,module,exports) {
...
(function() {
    ...
    confirmBtn.addEventListener("click", function(event) {
        ...
        //更新成员列表
        (0, _globalJs.updateGroupMembersList)((0, _globalJs.currentGroupID));
        //更新任务列表
        (0, _globalJs.updateTaskList)((0, _globalJs.currentGroupID), (0, _globalJs.currentUserID));
    });
    otherUser.addEventListener("click", function(event) {
        if (event.target.classList.contains("user-avatar")) {
            ...
            while(userInstance && !userInstance.classList.contains("user-instance"))userInstance = userInstance.parentElement;
            if (userInstance) {
...
},{"./global.js":"8mNOi"}]},["ftFza","g3FPD"], "g3FPD", "parcelRequire2914")

//# sourceMappingURL=team_01.cfbd1baa.js.map
